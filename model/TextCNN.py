    ...
    def __init__(
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s" % filter_size):
                ...
                # Maxpooling over the outputs  [None,1,1,num_filters]
        ...
        self.h_pool = tf.concat(pooled_outputs, 3)         # [None,1,1,num_filters*3]
        self.h_pool_flat = tf.reshape(self.h_pool, [-1, num_filters_total])     # [None,num_filters*3]
