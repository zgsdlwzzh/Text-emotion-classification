...
def train(x_train, y_train, x_test, y_test,params,
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            model=ATT_BiLSTM(sequence_length=params['sequence_length'],
            ...
            def train_step(x_batch, y_batch):
                ...
                feed_dict = {
                  ...
                  model.emb_dropout_keep_prob:params['emb_dropout_keep_prob'],
...
def main(save_loss_acc_path):
    ...
    train(x_train, y_train, x_test, y_test,params,
          att_bilstm2_train_summary_dir_path,att_bilstm2_test_summary_dir_path,
          att_bilstm2_checkpoint_dir_path,att_bilstm2_checkpoint_prefix_path)
